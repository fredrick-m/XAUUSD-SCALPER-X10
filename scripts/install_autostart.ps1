# Installs the auto-start shortcut. Portable: resolves the project root from
# this script's location, so it works on any machine (local PC or VPS).
...
$shortcut.Arguments = "`"$projectRoot\start_hidden.vbs`""
