"""
Strategy B005: EMA_5_13_ADX_STOCH_EMA200SLOPE
Family  : EMA_5_13
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    stoch_not_overbought = df["STOCH_K"] < p["stoch_overbought"]
    stoch_not_oversold   = df["STOCH_K"] > p["stoch_oversold"]

    long_conf  = trend_filter & stoch_not_overbought & ema200_slope_up
    short_conf = trend_filter & stoch_not_oversold   & ema200_slope_down
...
if __name__ == "__main__":
    ...
    print(f"Strategy B005: EMA_5_13_ADX_STOCH_EMA200SLOPE")
