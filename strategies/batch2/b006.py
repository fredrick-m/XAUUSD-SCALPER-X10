"""
Strategy B006: EMA_5_13_ADX_EMA200_RSI
Family  : EMA_5_13
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S002
Filters : ADX > 25, Close above EMA200 (long) / below EMA200 (short), RSI > 50 (long) / RSI < 50 (short)
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["Close"] > df["EMA200"]) & (df["RSI"] > 50)
    short_conf = trend_filter & (df["Close"] < df["EMA200"]) & (df["RSI"] < 50)
...
if __name__ == "__main__":
    ...
    print(f"Strategy B006: EMA_5_13_ADX_EMA200_RSI")
