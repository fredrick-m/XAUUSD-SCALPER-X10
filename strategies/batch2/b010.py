"""
Strategy B010: EMA_5_13_ADX_ATR_EXPANSION_RSI
Family  : EMA_5_13
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S002
Filters : ADX > 25, ATR expansion (ATR > ATR_avg * 0.8), RSI momentum confirmation
...
if __name__ == "__main__":
    ...
    print(f"Strategy B010: EMA_5_13_ADX_ATR_EXPANSION_RSI")
