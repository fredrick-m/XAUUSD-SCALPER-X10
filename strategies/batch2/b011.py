"""
Strategy B011: EMA_5_13_ADX_VOL_BULLBAR
Family  : EMA_5_13
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S002
Filters : ADX > 25, Volume > vol_ma20, bullish bar (close > open) for long / bearish bar (close < open) for short
...
if __name__ == "__main__":
    ...
    print(f"Strategy B011: EMA_5_13_ADX_VOL_BULLBAR")
