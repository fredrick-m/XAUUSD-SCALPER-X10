"""
Strategy B012: EMA_5_13_ADX_EMA50_STOCH_K
Family  : EMA_5_13
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S002
Filters : ADX > 25, EMA50 as bias filter, Stochastic K > 50 (long) / K < 50 (short)
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["Close"] > df["EMA50"]) & (df["STOCH_K"] > 50)
    short_conf = trend_filter & (df["Close"] < df["EMA50"]) & (df["STOCH_K"] < 50)
...
if __name__ == "__main__":
    ...
    print(f"Strategy B012: EMA_5_13_ADX_EMA50_STOCH_K")
