"""
Strategy B013: EMA_5_13_ADX30_RSI_EMA200_VOL
Family  : EMA_5_13
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S002
Filters : ADX > 30, RSI > 55 (long) / RSI < 45 (short), EMA200 trend, Volume > vol_ma
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["RSI"] > p["rsi_long"])  & (df["Close"] > df["EMA200"]) & vol_filter
    short_conf = trend_filter & (df["RSI"] < p["rsi_short"]) & (df["Close"] < df["EMA200"]) & vol_filter
...
if __name__ == "__main__":
    ...
    print(f"Strategy B013: EMA_5_13_ADX30_RSI_EMA200_VOL")
