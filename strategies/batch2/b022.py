"""
Strategy B022: EMA_9_18_ADX_RSI55_VOL
Family  : EMA_9_18
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S009
Filters : ADX > 25, RSI > 55 (long) / RSI < 45 (short), Volume > vol_ma
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["RSI"] > p["rsi_long"])  & vol_filter
    short_conf = trend_filter & (df["RSI"] < p["rsi_short"]) & vol_filter
...
if __name__ == "__main__":
    ...
    print(f"Strategy B022: EMA_9_18_ADX_RSI55_VOL")
