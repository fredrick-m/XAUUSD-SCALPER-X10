"""
Strategy B028: EMA_9_18_ADX_MACD_RSI_NOTEXTREME
Family  : EMA_9_18
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S009
Filters : ADX > 25, MACD bullish/bearish, RSI < 70 (long) / RSI > 30 (short)
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["MACD_hist"] > 0) & (df["RSI"] < p["rsi_long_max"])
    short_conf = trend_filter & (df["MACD_hist"] < 0) & (df["RSI"] > p["rsi_short_min"])
...
if __name__ == "__main__":
    ...
    print(f"Strategy B028: EMA_9_18_ADX_MACD_RSI_NOTEXTREME")
