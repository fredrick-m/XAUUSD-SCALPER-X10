"""
Strategy B035: EMA_9_18_ADX_MACD_RSI_RANGE
Family  : EMA_9_18
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S009
Filters : ADX > 25, MACD positive histogram, RSI 45-70 (long) / RSI 30-55 (short)
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["MACD_hist"] > 0) & rsi_long_range
    short_conf = trend_filter & (df["MACD_hist"] < 0) & rsi_short_range
...
if __name__ == "__main__":
    ...
    print(f"Strategy B035: EMA_9_18_ADX_MACD_RSI_RANGE")
