"""
Strategy B036: EMA_9_18_ADX_EMA20_VOL
Family  : EMA_9_18
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S009
Filters : ADX > 25, Price above EMA20 (long) / below EMA20 (short), Volume > vol_ma
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["Close"] > df["EMA20"]) & vol_filter
    short_conf = trend_filter & (df["Close"] < df["EMA20"]) & vol_filter
...
if __name__ == "__main__":
    ...
    print(f"Strategy B036: EMA_9_18_ADX_EMA20_VOL")
