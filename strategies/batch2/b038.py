"""
Strategy B038: EMA_9_18_ADX_CCI_VOL
Family  : EMA_9_18
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S009
Filters : ADX > 25, CCI > 0 (long) / CCI < 0 (short), Volume > vol_ma
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["CCI"] > 0) & vol_filter
    short_conf = trend_filter & (df["CCI"] < 0) & vol_filter
...
if __name__ == "__main__":
    ...
    print(f"Strategy B038: EMA_9_18_ADX_CCI_VOL")
