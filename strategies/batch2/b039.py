"""
Strategy B039: EMA_9_18_ADX30_TRIPLE_RSI_MACD_VOL
Family  : EMA_9_18
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S009
Filters : ADX > 30, RSI > 55 / RSI < 45, MACD positive / negative, Volume > vol_ma (triple confirmation)
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["RSI"] > p["rsi_long"])  & (df["MACD_hist"] > 0) & vol_filter
    short_conf = trend_filter & (df["RSI"] < p["rsi_short"]) & (df["MACD_hist"] < 0) & vol_filter
...
if __name__ == "__main__":
    ...
    print(f"Strategy B039: EMA_9_18_ADX30_TRIPLE_RSI_MACD_VOL")
