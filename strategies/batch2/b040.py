"""
Strategy B040: EMA_9_18_ADX_WILLR_EMA_TREND
Family  : EMA_9_18
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    willr_not_ob = df["WILLR"] < p["willr_overbought"]
    willr_not_os = df["WILLR"] > p["willr_oversold"]
...
if __name__ == "__main__":
    ...
    print(f"Strategy B040: EMA_9_18_ADX_WILLR_EMA_TREND")
