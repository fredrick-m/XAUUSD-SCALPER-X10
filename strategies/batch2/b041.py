"""
Strategy B041: EMA_3_8_ADX_RSI_VOL_FASTSCALP
Family  : EMA_NEW_VARIANTS
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : EMA_3_8
Filters : ADX > 25, RSI > 50 (long) / RSI < 50 (short), Volume > vol_ma
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & (df["RSI"] > 50) & vol_filter
    short_conf = trend_filter & (df["RSI"] < 50) & vol_filter
...
if __name__ == "__main__":
    ...
    print(f"Strategy B041: EMA_3_8_ADX_RSI_VOL_FASTSCALP")
