"""
Strategy B048: EMA_9_18_ADX_TRIPLE_EMA_ALIGN_VOL
Family  : EMA_NEW_VARIANTS
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Base    : S009
Filters : ADX > 25, triple EMA alignment (EMA9 > EMA18 > EMA50 for long), Volume > vol_ma
...
def generate_signals(df: pd.DataFrame, p: dict = PARAMS) -> pd.DataFrame:
    ...
    long_conf  = trend_filter & triple_bull & vol_filter
    short_conf = trend_filter & triple_bear & vol_filter
...
if __name__ == "__main__":
    ...
    print(f"Strategy B048: EMA_9_18_ADX_TRIPLE_EMA_ALIGN_VOL")
