"""
Strategy S018: BB_20_2p5_Breakout
Family  : BB
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: BB(20,2.5) wide-band breakout
...
Entry  : Long: close breaks above upper BB; Short: close breaks below lower BB
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S018: BB_20_2p5_Breakout")
