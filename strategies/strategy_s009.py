"""
Strategy S009: EMA_9_18_Cross
Family  : EMA
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: EMA 9/18 double-period scalp
...
Entry  : Bullish: fast EMA crosses above slow EMA; Bearish: fast crosses below slow
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S009: EMA_9_18_Cross")
