"""
Strategy S020: BB_20_2_Reversion
Family  : BB
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: BB(20,2) mean reversion scalp
...
Entry  : Long: close touches/crosses below lower BB then re-enters; Short: touches upper BB then re-enters
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S020: BB_20_2_Reversion")
