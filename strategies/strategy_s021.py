"""
Strategy S021: MACD_12_26_9_Cross
Family  : MACD
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: MACD(12,26,9) classic line crossover
...
Entry  : Long: MACD line crosses above signal; Short: MACD line crosses below signal
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S021: MACD_12_26_9_Cross")
