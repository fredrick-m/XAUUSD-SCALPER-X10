"""
Strategy S030: ATR_MeanReversion_14
Family  : ATR
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: ATR(14) mean reversion scalp
...
Entry  : Long: price dips > ATR_mult ATRs below recent high; Short: price rallies > ATR_mult ATRs above recent low
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S030: ATR_MeanReversion_14")
