"""
Strategy S035: EMA_10_20_RSI_21
Family  : EMA+RSI
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: EMA 10/20 cross + RSI 21 filter
...
Entry  : Long: fast EMA crosses above slow AND RSI below overbought; Short: cross down AND RSI above oversold
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S035: EMA_10_20_RSI_21")
