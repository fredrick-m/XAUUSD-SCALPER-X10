"""
Strategy S040: EMA_5_13_BB_10_1p5
Family  : EMA+BB
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: EMA 5/13 cross + BB(10,1.5) tight filter
...
Entry  : Long: fast EMA crosses above slow AND close near/above BB upper; Short: cross down AND close near/below BB lower
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S040: EMA_5_13_BB_10_1p5")
