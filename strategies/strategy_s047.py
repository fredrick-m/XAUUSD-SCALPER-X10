"""
Strategy S047: EMA_8_21_MACD_12_26_9_RSI_14
Family  : EMA+MACD+RSI
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: EMA 8/21 + MACD(12,26,9) + RSI 14 triple confluence
...
Entry  : Long: EMA cross up + MACD cross up + RSI < ob; Short: EMA cross down + MACD cross down + RSI > os
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S047: EMA_8_21_MACD_12_26_9_RSI_14")
