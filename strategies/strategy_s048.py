"""
Strategy S048: EMA_3_8_RSI_7_ATR_14
Family  : EMA+RSI+ATR
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: EMA 3/8 + RSI 7 + ATR(14) triple confluence
...
Entry  : Long: EMA cross up + RSI < ob + ATR confirms volatility; Short: EMA cross down + RSI > os + ATR confirms
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S048: EMA_3_8_RSI_7_ATR_14")
