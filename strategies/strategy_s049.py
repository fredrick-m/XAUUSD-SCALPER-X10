"""
Strategy S049: EMA_10_20_BB_20_2_ATR_14
Family  : EMA+BB+ATR
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: EMA 10/20 + BB(20,2) + ATR(14) triple confluence
...
Entry  : Long: EMA cross up + price above BB mid + ATR active; Short: cross down + price below BB mid + ATR active
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S049: EMA_10_20_BB_20_2_ATR_14")
