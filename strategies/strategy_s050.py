"""
Strategy S050: MACD_5_13_5_RSI_14_BB_20_2
Family  : MACD+RSI+BB
Goal    : XAUUSD-SCALPER-X10 — x10 returns in < 20 days
Timeframe: M1 (XAUUSD)
Description: MACD(5,13,5) + RSI 14 + BB(20,2) triple confluence
...
Entry  : Long: MACD cross up + RSI < ob + price above BB mid; Short: MACD cross down + RSI > os + price below BB mid
...
if __name__ == "__main__":
    df = load_data()
    result = backtest(df)
    print("Strategy S050: MACD_5_13_5_RSI_14_BB_20_2")
